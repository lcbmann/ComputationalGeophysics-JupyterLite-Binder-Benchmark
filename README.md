...
This repository compares MyBinder and JupyterLite for four animation notebooks derived from the Computational Geophysics short course.
...
- `notebooks/04_original_fe_elastic_waves_1d_no_progress.ipynb`: same FE workload as tier 3, but without repeated progress-display updates
...
- Original FE without progress: https://lcbmann.github.io/ComputationalGeophysics-JupyterLite-Binder-Benchmark/lab/index.html?path=notebooks/04_original_fe_elastic_waves_1d_no_progress.ipynb
...
- Original FE without progress: https://mybinder.org/v2/gh/lcbmann/ComputationalGeophysics-JupyterLite-Binder-Benchmark/HEAD?urlpath=lab/tree/notebooks/04_original_fe_elastic_waves_1d_no_progress.ipynb
